...
\cvline{Ph.D, 2024}{Linguistics, McGill University} 
	\noteline{\textit{(expected)}}{Dissertation: \textit{Event structure and serial verbs in Hmong.}\par Committee: Jessica Coon and Luis Alonso-Ovalle (co-supervisors), Junko Shimoyama, and Lisa Travis.}
...
\cvline{Sep.\ 2024--present}{Postdoctoral fellow\\
	Department of Linguistics\\
	Université du Québec à Montréal\\ 
	Supervisor: Richard Compton}
	
%\cvline{Fall 2024}{Instructor\\Department of Linguistics\\McGill University}

\cvline{Winter 2023}{Instructor\\Department of Linguistics\\McGill University}

\cvline{Winter 2021}{Instructor\\Department of Linguistics\\McGill University}


%%% RESEARCH %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Research}

\subsection{Grants \& Fellowships}% Should go here, if I had something to show off
...
%\pub{\textbf{Johnston, William.} (Forthcoming). ``'' In: \textit{Proceedings of the 42\textsuperscript{nd} West Coast Conference on Formal Linguistics}. %Ed.\ by}
\pub{\textbf{Johnston, William.} (Forthcoming). ``Two diagnostics for preposition-hood: Decomposing Path in White Hmong.'' In: \textit{Proceedings of GLOW in Asia XIV}. %Ed.\ by 
}
...
\pub{\textbf{Johnston, William.} (Revised and resubmitted). ``Causation and serialization in White Hmong.''} %[\href{https://ling.auf.net/lingbuzz/007585}{lingbuzz}]
...
%\cvline{Fall 2024}{%
%	Topics at the Interfaces 1 - Event Structure (LING 417)\\
