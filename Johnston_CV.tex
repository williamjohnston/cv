...
\pub{\textbf{Johnston, William.} (In revision). ``Nonspecific promises: The Intensional Restitution Effect.'' %[\href{}{lingbuzz}]
} 
...
%Jessica Coon\smallskip\\
%Dept.\ of Linguistics, McGill University\\
%1085 ave Dr. Penfield, room \#221\\
%Montréal, QC H3A 1A7, Canada\smallskip\\
%\href{mailto:jessica.coon@mcgill.ca}{jessica.coon@mcgill.ca}\medskip\\
%\end{minipage}%
%%
%\begin{minipage}[t]{0.5\textwidth}
%Luis Alonso-Ovalle\smallskip\\
%Dept.\ of Linguistics, McGill University\\
%1085 ave Dr. Penfield, room \#314\\
%Montréal, QC H3A 1A7, Canada\smallskip\\
%\href{mailto:luis.alonso-ovalle@mcgill.ca}{luis.alonso-ovalle@mcgill.ca}\bigskip\\
%\end{minipage}
%
%\begin{minipage}[t]{0.5\textwidth}
%Lisa Travis\smallskip\\
%Dept.\ of Linguistics, McGill University\\
%1085 ave Dr. Penfield, room \#111\\
%Montreal, QC H3A 1A7, Canada\medskip\\
%\href{mailto:lisa.travis@mcgill.ca}{lisa.travis@mcgill.ca}
%\end{minipage}
